...
function Armory:OnCreate()
	...
	Log("%s.OnCreate time 1: %s", self:GetId(), os.clock());
	...
	Log("%s.OnCreate time 2: %s", self:GetId(), os.clock());
end
...
function Armory:OnInitialized()
	...
	Log("%s.OnInitialized time 1: %s", self:GetId(), os.clock());
	...
	Log("%s.OnInitialized time 2: %s", self:GetId(), os.clock());
